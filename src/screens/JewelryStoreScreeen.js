...
const JewelryStoreScreen = ({navigation}) => {
  const {jewelry} = useContext(ProductContext);
  return (
        <ScrollView>
            <View style={styles.wrap}>
            <Image source={require('../../assets/JewelleryStore.png')} resizeMode = 'contain' style={styles.wrapImg}
            />
            </View>
...
export default JewelryStoreScreen;